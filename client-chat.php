...
<head>
  ...
  <title>Chat Messages - SkillBridge</title>
          ...
          <div style="display: flex; flex-direction: column; gap: 10px;">
            ...
            <div
              ...
              <div style="flex: 1; min-width: 0;">
                <p style="font-weight: 600; margin: 0; font-size: 0.95rem;">Mira Tabassum</p>
                <p style="color: var(--gray-600); margin: 0; font-size: 0.85rem;">Freelancer</p>
              </div>
            </div>
            ...
            <div
              ...
              <div style="flex: 1; min-width: 0;">
                ...
                <p style="color: var(--gray-600); margin: 0; font-size: 0.85rem;">Developer</p>
              </div>
            </div>
            ...
            <div
              ...
              <div style="flex: 1; min-width: 0;">
                ...
                <p style="color: var(--gray-600); margin: 0; font-size: 0.85rem;">Designer</p>
              </div>
            </div>
            ...
            <div
              style="display: flex; align-items: center; gap: 12px; padding: 12px; background: #f9f9f9; border-radius: 10px; cursor: pointer;">
              <div
                style="width: 45px; height: 45px; background: linear-gradient(135deg, #ef4444, #dc2626); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: 600; font-size: 0.9rem;">
                ED</div>
              <div style="flex: 1; min-width: 0;">
                <p style="font-weight: 600; margin: 0; font-size: 0.95rem;">Emily Davis</p>
                <p style="color: var(--gray-600); margin: 0; font-size: 0.85rem;">Writer</p>
              </div>
            </div>
          ...
          <div
            ...
            <div style="display: flex; align-items: center; gap: 15px;">
              <div
                ...
                MT</div>
              <div>
                <h3 style="font-size: 1.3rem; font-weight: 600; margin: 0 0 0.25rem 0;">Mira Tabassum</h3>
                <p style="color: var(--gray-600); margin: 0; font-size: 0.95rem;"><i class="fas fa-user-tie"
                    style="margin-right: 0.5rem;"></i>Freelancer</p>
              </div>
            </div>
            <a href="freelancer-dashboard.html" class="btn btn-primary btn-sm">View Profile</a>
          </div>

          <!-- Messages -->
          <div style="flex: 1; overflow-y: auto; padding: 0 20px;">
            <div class="messages-list" style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 1.5rem;">
              <div class="message-item"
                style="background: #f9f9f9; border-radius: 10px; padding: 16px; border-left: 4px solid var(--blue-600);">
                <div
                  style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem;">
                  <p style="font-weight: 600; margin: 0;">Mira Tabassum</p>
                  <span style="font-size: 0.85rem; color: var(--gray-500);">10:30 AM</span>
                </div>
                <p style="color: var(--gray-600); margin: 0;">Hey, I need a UI/UX design for my website</p>
              </div>
              <div class="message-item"
                ...
                <div
                  ...
                  <span style="font-size: 0.85rem; color: var(--gray-500);">10:32 AM</span>
                </div>
                <p style="color: var(--gray-600); margin: 0;">Sure, I can help you with that</p>
              </div>
              <div class="message-item"
                style="background: linear-gradient(135deg, rgba(156, 199, 70, 0.1) 0%, rgba(49, 157, 214, 0.1) 100%); border-radius: 10px; padding: 16px; border-left: 4px solid #10b981;">
                <div
                  style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem;">
                  <p style="font-weight: 600; margin: 0;">You</p>
                  <span style="font-size: 0.85rem; color: var(--gray-500);">10:35 AM</span>
                </div>
                <p style="color: var(--gray-600); margin: 0;">I have attached some samples for your review</p>
              </div>
            </div>
          </div>
