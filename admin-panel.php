...
<head>
  ...
  <title>Admin Panel - SkillBridge</title>
  ...
  <div class="dashboard admin-panel-main">
    <div class="container">
      ...
      <div class="admin-header">
        <h1>Welcome, Md. Junaed Khandakar</h1>
      ...
      <div class="admin-cards">
        <div class="admin-card">
          ...
          <a href="admin-dashboard.html" class="btn btn-primary btn-sm">Open</a>
        </div>

        <div class="admin-card">
          <h3>Freelancer Approvals</h3>
          <p>Approve or reject freelancer requests</p>
          <a href="admin-freelancer-approvals.html" class="btn btn-success btn-sm">Manage</a>
        </div>

        <div class="admin-card">
          <h3>Client Approvals</h3>
          <p>Verify and approve client accounts</p>
          <a href="admin-client-approvals.html" class="btn btn-success btn-sm">Manage</a>
        </div>

        <div class="admin-card">
          <h3>User Verification</h3>
          <p>Review identity & document verification</p>
          <a href="admin-verification.html" class="btn btn-secondary btn-sm">Review</a>
        </div>

        <div class="admin-card logout-card">
          <h3>Log Out</h3>
          <p>End your admin session securely</p>
          <a href="login.html" class="btn btn-danger btn-sm">Log Out</a>
        </div>
      </div>
    </div>
  </div>
